...
namespace ros { namespace threading
{
    namespace scheduling_policy
    {
        namespace
        {
            ...
            {
               LOT_TO_STRINGIZE_ENUM(LOT_SEQ_STANDARD_SCHEDULING_POLICIES)
            };

            const std::string REAL_TIME_POLICIES_STRINGS[] =
            {
               LOT_TO_STRINGIZE_ENUM(LOT_SEQ_REAL_TIME_SCHEDULING_POLICIES)
            };

            const boost::container::flat_map<Standard, int> STANDARD_POLICIES_VALUES =
            {{
                LOT_GENERATE_BRACED_ENUM_VALUE_PAIRS(
                    LOT_SEQ_STANDARD_SCHEDULING_POLICIES,
            ...
            {{
                LOT_GENERATE_BRACED_ENUM_VALUE_PAIRS(
                    LOT_SEQ_REAL_TIME_SCHEDULING_POLICIES,
