...
protected:
    using RosCallback = boost::function<void(ros::lot_msgs::SharedPtrConstShmImage)>;
    using SharedPtrConstShmImage = ros::lot_msgs::SharedPtrConstShmImage;
 ...
 * pub ---intra---> sub
 *
 * Publisher and subscriber live in the same OS process and communicate through LOT.
*/
 ...
 *  pub ---inter---> sub
 *
 * Publisher and subscriber live in different OS processes and communicate through LOT.
*/
 ...
 *  pub20---inter---/
 *
 * Publishers and the subscriber live in different OS processes and communicate through LOT.
*/
 ...
 *      \--inter---> sub20
 *
 * The publisher and the subscribers live in different OS processes and communicate through LOT.
*/
 ...
 * achieved through LOT in either case.
*/
 ...
 * achieved through LOT in all cases.
*/
